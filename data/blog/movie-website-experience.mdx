...
This one has already been spoiled, but Chakra-UI ships with a dark mode by default, so this was incredibly easy, and all you have to do to check out <TextColorMode /> mode is hit that toggle button up top!
