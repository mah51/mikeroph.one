...
tags: ['Web Development', 'Next.JS', 'Chakra-UI']
...
_Whilst I don't need all the data, I am saving it incase I want to use it later._
...
This one has already been spoilt, but Chakra-UI ships with a dark mode by default, so this was incredibly easy, and all you have to do to check out <TextColorMode /> mode is hit that toggle button up top!
